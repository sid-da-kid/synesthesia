...
class Deformer():
    def getmesh(self, img):
        ...
        topleft = ((w // 2, h // 2, w, h),(0, 0, 0, h, w // 2, h, w // 2, 0))
        topright = ((0, h // 2, w // 2, h),(w // 2, 0, w // 2, h, 0, h, 0, 0))
        bottomleft = ((w // 2, 0, w, h // 2),(0, h, 0, 0, w // 2, 0, w // 2, h))
        bottomright = ((0, 0, w // 2, h // 2),(w // 2, h, w // 2, 0, 0, 0, 0, h))
